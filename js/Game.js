class Game{
    ...
    play(){
        ...
        // Add code to destroy fruits, calculate scores and
           textSize(25);
           fill("white");
           text("Player 1: "+allPlayers.player1.name+"s score"+allPlayers.player1.score,50,50);
           text("Player 2: "+allPlayers.player2.name+"s score"+allPlayers.player2.score,50,100);
